...
namespace Metempsychoid.View.Layer2D.BoardNotifLayer2D
{
    public class CardEntityDecorator2D : CardEntity2D
    {
        ...
        public CardEntityDecorator2D(IObject2DFactory factory, ALayer2D layer2D, CardEntityDecorator entity) 
        ...
        private void InitializeStartState()
        {
            ...
            {
                Vector2f fromPosition = (layer2D as BoardNotifLayer2D).GetPositionFrom((layer2D.GetEntityFromEntity2D(this) as CardEntityDecorator).CardEntityDecorated.ParentLayer, this.initialPosition);
